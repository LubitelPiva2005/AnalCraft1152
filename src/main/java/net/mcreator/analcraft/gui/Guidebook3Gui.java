...
public class Guidebook3Gui extends AnalCraftModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public Guidebook3Gui(AnalCraftModElements instance) {
		super(instance, 245);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("guidebook_3"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("anal_craft:textures/guidebook_3.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("anal_craft:textures/axe.png"));
			this.blit(this.guiLeft + 19, this.guiTop + 18, 0, 0, 120, 58, 120, 58);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("anal_craft:textures/pickaxe.png"));
			this.blit(this.guiLeft + 172, this.guiTop + 18, 0, 0, 120, 58, 120, 58);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("anal_craft:textures/sword.png"));
			this.blit(this.guiLeft + 19, this.guiTop + 90, 0, 0, 120, 58, 120, 58);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("anal_craft:textures/spermemeat.png"));
