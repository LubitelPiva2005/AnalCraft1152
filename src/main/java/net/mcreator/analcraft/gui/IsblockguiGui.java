...
import net.mcreator.analcraft.procedures.IsblockguitradeProcedure;
...
public class IsblockguiGui extends AnalCraftModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public IsblockguiGui(AnalCraftModElements instance) {
		super(instance, 387);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("isblockgui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("anal_craft:textures/isblockgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Throw me some bucks(300$)", 6, 70, -12829636);
		}
		...
		if (buttonID == 0) {
			{
				...
				IsblockguitradeProcedure.executeProcedure($_dependencies);
			}
		}
	}
