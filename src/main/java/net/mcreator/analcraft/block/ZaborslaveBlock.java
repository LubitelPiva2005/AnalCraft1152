...
public class ZaborslaveBlock extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:zaborslave")
	public static final Block block = null;
	public ZaborslaveBlock(AnalCraftModElements instance) {
		super(instance, 69);
	}
