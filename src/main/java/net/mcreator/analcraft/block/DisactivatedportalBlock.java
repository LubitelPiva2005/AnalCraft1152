...
import net.mcreator.analcraft.procedures.DisactivatedportalOnBlockRightClickedProcedure;
...
public class DisactivatedportalBlock extends AnalCraftModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("disactivatedportal");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				DisactivatedportalOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
