...
public class CloseddoorBlock extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:closeddoor")
	public static final Block block = null;
	public CloseddoorBlock(AnalCraftModElements instance) {
		super(instance, 410);
	}
