...
public class VandoorBlock extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:vandoor")
	public static final Block block = null;
	public VandoorBlock(AnalCraftModElements instance) {
		super(instance, 72);
	}
