...
import net.mcreator.analcraft.procedures.IsblockOnBlockRightClickedProcedure;
...
public class IsblockBlock extends AnalCraftModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				IsblockOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
