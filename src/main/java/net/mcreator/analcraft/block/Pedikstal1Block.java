...
import net.mcreator.analcraft.procedures.Pedikstal1OnBlockRightClickedProcedure;
...
public class Pedikstal1Block extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:pedikstal_1")
	public static final Block block = null;
	public Pedikstal1Block(AnalCraftModElements instance) {
		super(instance, 220);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				Pedikstal1OnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
