...
public class VantrapdoorBlock extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:vantrapdoor")
	public static final Block block = null;
	public VantrapdoorBlock(AnalCraftModElements instance) {
		super(instance, 71);
	}
