...
public class OldCumBlockBlock extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:old_cum_block")
	public static final Block block = null;
	public OldCumBlockBlock(AnalCraftModElements instance) {
		super(instance, 56);
	}
