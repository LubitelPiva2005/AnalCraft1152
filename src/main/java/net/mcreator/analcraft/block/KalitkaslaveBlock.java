...
public class KalitkaslaveBlock extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:kalitkaslave")
	public static final Block block = null;
	public KalitkaslaveBlock(AnalCraftModElements instance) {
		super(instance, 70);
	}
