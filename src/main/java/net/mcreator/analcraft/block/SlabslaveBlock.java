...
public class SlabslaveBlock extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:slabslave")
	public static final Block block = null;
	public SlabslaveBlock(AnalCraftModElements instance) {
		super(instance, 317);
	}
