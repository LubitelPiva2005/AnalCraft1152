...
public class AncientseemenarmotItem extends AnalCraftModElements.ModElement {
	@ObjectHolder("anal_craft:ancientseemenarmot_helmet")
	public static final Item helmet = null;
	@ObjectHolder("anal_craft:ancientseemenarmot_chestplate")
	public static final Item body = null;
	@ObjectHolder("anal_craft:ancientseemenarmot_leggings")
