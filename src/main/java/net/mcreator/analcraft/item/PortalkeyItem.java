...
import net.mcreator.analcraft.procedures.PortalkeyRightClickedOnBlockProcedure;
...
public class PortalkeyItem extends AnalCraftModElements.ModElement {
	...
	public void initElements() {
		...
		}.setRegistryName("portalkey"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(ANALTABItemGroup.tab).maxDamage(1));
		}
