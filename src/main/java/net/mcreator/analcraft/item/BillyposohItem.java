...
public class BillyposohItem extends AnalCraftModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(LightbarItem.block, (int) (1)), new ItemStack(Items.TRIDENT, (int) (1)));
			}
		}, 3, -3f, new Item.Properties().group(AnalCraftSnariazhenieItemGroup.tab)) {
			@Override
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					BillyposohRightClickedInAirProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
