...
public class LatexbagItem extends AnalCraftModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(AnalToolItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("latexbag");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Мешочек из latex");
					}
