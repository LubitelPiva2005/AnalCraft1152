...
import net.mcreator.analcraft.procedures.BigtreeOnStructureInstanceGeneratedProcedure;
...
public class BigtreeStructure extends AnalCraftModElements.ModElement {
	public BigtreeStructure(AnalCraftModElements instance) {
		super(instance, 191);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
								...
								.addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK).setChunk(null).setIgnoreEntities(false));
						{
							...
							BigtreeOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
						}
					}
				}
				return true;
