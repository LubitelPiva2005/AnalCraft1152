...
import net.mcreator.analcraft.procedures.BigOnStructureInstanceGeneratedProcedure;
				...
				if ((random.nextInt(1000000) + 1) <= 50000) {
					...
					for (int a = 0; a < count; a++) {
								...
								.addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK).setChunk(null).setIgnoreEntities(false));
						{
							...
							BigOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
						}
					}
				}
				return true;
