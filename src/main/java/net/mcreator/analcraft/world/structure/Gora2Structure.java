...
public class Gora2Structure extends AnalCraftModElements.ModElement {
	public Gora2Structure(AnalCraftModElements instance) {
		super(instance, 208);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 5000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("anal_craft", "gora22"));
						if (template == null)
							return false;
