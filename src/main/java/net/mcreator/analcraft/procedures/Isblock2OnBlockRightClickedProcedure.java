	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == IsblockBlock.block.getDefaultState().getBlock())) {
				...
				if (_ent instanceof ServerPlayerEntity) {
					...
					NetworkHooks.openGui((ServerPlayerEntity) _ent, new INamedContainerProvider() {
						...
						public ITextComponent getDisplayName() {
							return new StringTextComponent("Isblockgui");
						}

						@Override
						public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
							return new IsblockguiGui.GuiContainerMod(id, inventory, new PacketBuffer(Unpooled.buffer()).writeBlockPos(_bpos));
						}
					}, _bpos);
				}
			}
		} else {
			{
				...
				if (mcserv != null)
					mcserv.getPlayerList().sendMessage(new StringTextComponent("\u041D\u0435\u0442 \u0441\u0438\u0433\u043D\u0430\u043B\u0430"));
			}
		}
	}
}
